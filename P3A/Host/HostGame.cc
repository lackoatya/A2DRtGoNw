...
void HostGame::Process_Hero_Input(Game::HeroState * _current, const Game::HeroInput * _input) {
  switch (*_input) {
...
void HostGame::Process_Hero_State(const Game::HeroState * _current, Game::HeroState * _next) {
  _next->copy(*_current);
